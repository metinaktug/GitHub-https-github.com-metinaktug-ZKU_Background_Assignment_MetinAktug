...
contract Ballot {
    ...
    uint256 [] public startTime = [block.timestamp, block.timestamp + 300]; // 300 seconds is five minutes
    ...
    function delegate(address to) voteEnded_timeNOK external {
       ...
       //require((startTime [0] = block.timestamp) <= startTime [1], "5 minutes are up"); //voteEnded_timeNOK                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
